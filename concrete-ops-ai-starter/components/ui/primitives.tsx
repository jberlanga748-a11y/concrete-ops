...
export const appBackgroundClassName =
  "bg-[radial-gradient(circle_at_top_left,_rgba(249,115,22,0.12),_transparent_24%),radial-gradient(circle_at_top_right,_rgba(24,24,27,0.08),_transparent_26%),linear-gradient(180deg,#f5f5f4_0%,#fafaf9_100%)]";
export const brandPanelClassName =
  "bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(250,250,249,0.94)),radial-gradient(circle_at_top_left,rgba(249,115,22,0.08),transparent_34%)]";
...
export const subtleButtonClassName =
  "inline-flex items-center justify-center gap-2 rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm font-medium text-zinc-700 transition hover:bg-zinc-100 focus:outline-none focus:ring-4 focus:ring-zinc-100 disabled:cursor-not-allowed disabled:opacity-50";
...
function HeaderTexture() {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "radial-gradient(circle at 1px 1px, rgba(39,39,42,0.18) 1px, transparent 0), linear-gradient(135deg, rgba(249,115,22,0.12), transparent 32%)",
  ...
  return (
    <section
      className={cn(
        ...
        "bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(255,247,237,0.92)),radial-gradient(circle_at_top_right,rgba(249,115,22,0.18),transparent_38%)]",
      )}
    >
      <HeaderTexture />
