  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border bg-white p-6 shadow-sm">
        ...
        <p className="mt-3 text-zinc-600">Employee clock in/out writes live time entries, and admin reads the same records below.</p>
      </div>
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        ...
        <div className="space-y-4">
          ...
          <form className="flex flex-wrap gap-3 rounded-2xl border bg-white p-4" method="get">
            ...
            <select name="employeeId" defaultValue={selectedEmployeeId} className="rounded-xl border px-3 py-2 text-sm">
