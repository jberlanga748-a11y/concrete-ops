          ...
          <div className="grid gap-4 xl:grid-cols-[1fr_360px]">
            <div className="min-w-0">
              <TableShell
                ...
                filters={
                  <FilterBar>
                    <form method="get" className="grid gap-2 md:grid-cols-[minmax(0,1fr)_220px_auto_auto] md:items-center">
                      ...
                      <input name="date" type="date" defaultValue={selectedDate} aria-label="Date" className="h-10 w-full rounded-xl border border-blue-100 bg-white px-3 text-sm font-bold text-slate-700 outline-none focus:border-blue-500" />
            ...
            <RecordPreview
              ...
              rows={[
                ...
                ["Date", selectedDate ? formatDateOnly(selectedDate) : "All dates"],
